...
emissions_long_1990_2022 = emissions_long[emissions_long["year"] > 1989]

# Query for 5 countries (adjust these to any countries you like)
emissions_long_subset = emissions_long_1990_2022[
    (emissions_long_1990_2022['country'] == "Guatemala") | (emissions_long_1990_2022['country'] == "El Salvador") | (emissions_long_1990_2022['country'] == "Honduras") |
    (emissions_long_1990_2022['country'] == "Costa Rica") |
    (emissions_long_1990_2022['country'] == "Nicaragua") |
    (emissions_long_1990_2022['country'] == "Panama")]

# Create line chart. Year should be on the x-axis, emissions on the y-axis, and color should be by country.
fig_chart = px.line(emissions_long_subset, x = "year", y = "emissions", color = "country", labels = {"emissions": "Emissions (CO2)"}, title = "Selected Countries CO2 Emissions (1990-2022)")
fig_chart
```
...
fig_map = px.choropleth(
    ...
    labels = {"emissions": "Emissions (CO2)"},
